...
public class PassViss {
  ...
  public void testPassViss() throws Exception {
    ...
    // ERROR: Caught exception [Error: unknown strategy [class] for locator [class=glyphicon glyphicon-eye-open]]
    assertEquals("test426", driver.findElement(By.id("field_password")).getText());
