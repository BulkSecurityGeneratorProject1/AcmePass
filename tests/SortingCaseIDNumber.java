...
public class SortingCaseIDNumber extends TestCase{
  ...
  @Test
  public void testSortingCase2() throws Exception {
    driver.get(baseUrl + "/#/");
    ...
    try {
      assertEquals("119", driver.findElement(By.cssSelector("td")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.cssSelector("span.glyphicon.glyphicon-sort-by-attributes")).click();
    try {
      assertEquals("116", driver.findElement(By.cssSelector("td")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
